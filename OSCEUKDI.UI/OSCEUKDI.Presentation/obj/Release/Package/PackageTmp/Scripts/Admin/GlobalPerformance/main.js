var tableGlobalPerformance = $('.table-globalPerformance').DataTable({
    "columnDefs": [{
        "searchable": false,
        "orderable": false,
        "paging": false,
    ...
    "order": [[0, 'asc']],
    "ajax": {
        url: '/Admin/GlobalPerformance/GetDataALL',
        type: 'POST',
        dataSrc: ''
    },
    "columns": [
            ...
            "render": function (data, type, row, meta) {
                ...
                return `<div class="row justify-content-center">
                            <div class="col" style="text-align:center">
                                <a class="btn-update " href="javascript:void(0)" onclick="javascript:$('#id').val('${data}');$('#updateGlobalPerformance').submit();" rel="tooltip" title="Edit" ><i class="fa fa-pencil-square-o" aria-hidden="true"style="font-size:20px"></i></a>
        ...
        },
        {
            ...
            "name": "NMin",
            "render": function (data, type, row, meta) {
                return '<div class="center">' + data + " <strong> - </strong> "+ row.NMax + '</div>';
            }
        },
