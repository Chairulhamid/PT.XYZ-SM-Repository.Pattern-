var mappingMahasiswa = $('.table-mappingMahasiswa').DataTable({
    "columnDefs": [{
        "searchable": false,
        "orderable": false,
        "paging": false,
    ...
    //"aaSorting": [[0, "asc"]],
    "ajax": {
        url: '/Admin/MappingMahasiswa/GetDataALL',
        type: 'POST',
        dataSrc: ''
    },
    "columns": [    
            ...
            "render": function (data, type, row, meta) {
                ...
                return `<div class="row justify-content-center">
                            <div class="col" style="text-align:center">
                                <a class="btn-update " href="javascript:void(0)" onclick="javascript:$('#id').val('${data}');$('#updateMappingMahasiswa').submit();" rel="tooltip" title="Edit" ><i class="fa fa-pencil-square-o" aria-hidden="true"style="font-size:20px"></i></a>
