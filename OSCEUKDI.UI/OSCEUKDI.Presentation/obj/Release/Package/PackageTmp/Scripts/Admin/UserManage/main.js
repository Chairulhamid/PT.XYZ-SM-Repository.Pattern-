...
/*button delete di grid summary*/
/*<a rel="tooltip" title="remove" onclick="Delete('${data}')" class="table-action remove" href="javascript:void(0)" title="remove"><span class="material-icons">delete_forever</span></a>*/
//<a href="javascript:void(0)" onclick="javascript:$('#id').val('${data}');$('#SelectUser').submit();" rel="tooltip" title="edit" ><span class="material-icons">edit</span></i></a>
