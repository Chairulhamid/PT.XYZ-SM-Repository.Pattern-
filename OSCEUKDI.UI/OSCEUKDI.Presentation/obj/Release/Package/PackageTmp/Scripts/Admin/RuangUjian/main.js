var tableRuanganUjian = $('.table-ruanganUjian').DataTable({
    "columnDefs": [{
        "searchable": false,
        "orderable": false,
        "paging": false,
    ...
    "ajax": {
        url: '/Admin/RuanganUjian/GetDataALL',
        type: 'POST',
        dataSrc: ''
    },
    "columns": [      
            ...
            "render": function (data, type, row, meta) {
                ...
                return `<div class="row justify-content-center">
                            <div class="col" style="text-align:center">
                                <a class="btn-update " href="javascript:void(0)" onclick="javascript:$('#id').val('${data}');$('#updateRuanganUjian').submit();" rel="tooltip" title="Edit" ><i class="fa fa-pencil-square-o" aria-hidden="true"style="font-size:20px"></i></a>
    ...
    "initComplete": function (d) {
        ...
        this.api().columns().every(function (index) {
            ...
            if (inputFilterOnColumn.indexOf(index) >= 0 && notApplyFilterOnColumn.indexOf(index) < 0) {
                ...
                var select = $('<select class="form-control"><option class="" value="">All</option></select>')
                    .on('change', function () {
