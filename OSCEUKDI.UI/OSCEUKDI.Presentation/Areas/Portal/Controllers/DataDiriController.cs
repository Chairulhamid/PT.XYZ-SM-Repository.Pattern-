...
namespace MBKM.Presentation.Areas.Portal.Controllers
{
    ...
    public class DataDiriController : Controller
    {
        ...
        public DataDiriController(IInformasiPertukaranService informasiPertukaranService,IMahasiswaService mahasiswaService, ILookupService lookupService, IAttachmentService attachmentService, IPerjanjianKerjasamaService perjanjianKerjasamaService)
        {
        ...
        public void UploadFilePendukung(FilePendukung filePendukung, Int64 id)
        {
            ...
            // 20221115 Bite
            if (filePendukung.buktiBayar != null)
            {
                UploadAttachment(id, filePendukung.buktiBayar, "BuktiBayar");
            }
        }
