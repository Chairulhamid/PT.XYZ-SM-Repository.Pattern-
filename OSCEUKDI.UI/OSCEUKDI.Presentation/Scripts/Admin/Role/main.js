var tableMenuRole = $('.table-role').DataTable({
    "columnDefs": [{
        "searchable": false,
        "orderable": false,
        "paging": false,
            ...
            "render": function (data, type, row, meta) {
                ...
                return `<div class="row justify-content-center">
                            <div class="col" style="text-align:center">
                                <a href="javascript:void(0)" onclick="javascript:$('#idRole').val('${data}');$('#name').val('${row.RoleName}');$('#RoleAccessMenu').submit();" rel="tooltip" title="Role Access Menu"><i class="fa fa-filter" aria-hidden="true"style="font-size:20px"></i></a>            
    ...
    "initComplete": function (d) {
        var notApplyFilterOnColumn = [0, 3];
